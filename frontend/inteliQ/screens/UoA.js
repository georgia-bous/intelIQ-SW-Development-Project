...
export default function UserOrAdmin(props) {
    ...
    const onPressB = () => {
        ...
        props.navigation.navigate("Questionnaires", { admin: false })   // the admin veriable shows if the user loged in as admin or not
    }
    ...
    const onPressAdmin = () => {
        if ((username == "admin") && (password == "admin"))         // hardcoded username and password
